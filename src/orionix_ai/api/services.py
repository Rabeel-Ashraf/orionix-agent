...
from orionix_ai.core.services.tools.mcp_service import MCPToolClient
...
from orionix_ai.core.services.tools.service_registry import ServiceRegistry, ToolServiceKind
from orionix_ai.core.tools import ToolService
...
ServiceOpenAPIParamsSourceField: TypeAlias = Annotated[
    ...
    Field(
        ...
        examples=["https://api.example.com/openapi.json", "/etc/orionix_ai/specs/example-api.yaml"],
    ),
]
