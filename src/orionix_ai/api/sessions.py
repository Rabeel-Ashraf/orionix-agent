...
from orionix_ai.api.authorization import AuthorizationPolicy, Operation
from orionix_ai.api.common import GuidelineIdField, ExampleJson, JSONSerializableDTO, apigen_config
from orionix_ai.api.glossary import TermSynonymsField, TermIdPath, TermNameField, TermDescriptionField
...
from orionix_ai.core.engines.types import UtteranceRationale, UtteranceRequest
from orionix_ai.core.loggers import Logger
from orionix_ai.core.nlp.generation_info import GenerationInfo
from orionix_ai.core.nlp.moderation import ModerationService
...
from orionix_ai.core.canned_responses import CannedResponseId
...
def _get_jailbreak_moderation_service(logger: Logger) -> ModerationService:
    from orionix_ai.adapters.nlp.lakera import LakeraGuard
