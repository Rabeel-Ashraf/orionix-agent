...
from orionix_ai.core.async_utils import ReaderWriterLock, safe_gather
from orionix_ai.core.common import JSONSerializable, md5_checksum
from orionix_ai.core.common import ItemNotFoundError, UniqueId, Version, IdGenerator, to_json_dict
from orionix_ai.core.guidelines import GuidelineId
from orionix_ai.core.nlp.embedding import Embedder, EmbedderFactory
from orionix_ai.core.persistence.common import (
    ObjectId,
    Where,
)
...
from orionix_ai.core.persistence.document_database_helper import (
    DocumentMigrationHelper,
    DocumentStoreMigrationHelper,
)
from orionix_ai.core.persistence.vector_database import (
    VectorCollection,
    VectorDatabase,
    BaseDocument as VectorDocument,
)
from orionix_ai.core.persistence.vector_database_helper import (
...
class JourneyVectorStore(JourneyStore):
    ...
    async def _vector_document_loader(self, doc: VectorDocument) -> Optional[JourneyVectorDocument]:
        async def v0_1_0_to_v0_3_0(doc: VectorDocument) -> Optional[VectorDocument]:
            raise Exception(
                "This code should not be reached! Please run the 'orionix_ai-prepare-migration' script."
            )
