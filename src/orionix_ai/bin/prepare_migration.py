...
from orionix_ai.core.capabilities import (
    CapabilityDocument,
...
from orionix_ai.core.common import generate_id, md5_checksum, Version
...
from orionix_ai.core.glossary import (
    GlossaryVectorStore,
    TermDocument_v0_1_0,
...
from orionix_ai.core.persistence.vector_database_helper import VectorDocumentStoreMigrationHelper
...
from orionix_ai.core.loggers import LogLevel, StdoutLogger
from orionix_ai.core.nlp.embedding import EmbedderFactory, NullEmbeddingCache
...
from orionix_ai.core.persistence.document_database_helper import MetadataDocument
...
LOGGER = StdoutLogger(
    ...
    logger_id="orionix_ai.bin.prepare_migration",
)
...
def backup_data() -> None:
    if Confirm.ask("Do you want to backup your data before migration?"):
        default_backup_dir = PARLANT_HOME_DIR.parent / "orionix_ai-data.orig"
        try:
