...
from orionix_agent.core.capabilities import (
    CapabilityDocument,
...
from orionix_agent.core.common import generate_id, md5_checksum, Version
...
from orionix_agent.core.glossary import (
    GlossaryVectorStore,
    TermDocument_v0_1_0,
...
from orionix_agent.core.persistence.vector_database_helper import VectorDocumentStoreMigrationHelper
...
from orionix_agent.core.loggers import LogLevel, StdoutLogger
from orionix_agent.core.nlp.embedding import EmbedderFactory, NullEmbeddingCache
from orionix_agent.core.persistence.common import ObjectId
from orionix_agent.core.persistence.document_database import (
    BaseDocument,
    DocumentDatabase,
    identity_loader,
)
from orionix_agent.core.persistence.document_database_helper import MetadataDocument
...
LOGGER = StdoutLogger(
    ...
    logger_id="orionix_agent.bin.prepare_migration",
)
...
def backup_data() -> None:
    if Confirm.ask("Do you want to backup your data before migration?"):
        default_backup_dir = PARLANT_HOME_DIR.parent / "orionix_agent-data.orig"
        try:
