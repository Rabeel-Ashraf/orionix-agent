...
from orionix_agent.core.async_utils import ReaderWriterLock, safe_gather
from orionix_agent.core.common import JSONSerializable, md5_checksum
from orionix_agent.core.common import ItemNotFoundError, UniqueId, Version, IdGenerator, to_json_dict
from orionix_agent.core.guidelines import GuidelineId
from orionix_agent.core.nlp.embedding import Embedder, EmbedderFactory
from orionix_agent.core.persistence.common import (
    ObjectId,
    Where,
)
...
from orionix_agent.core.persistence.document_database_helper import (
    DocumentMigrationHelper,
    DocumentStoreMigrationHelper,
)
from orionix_agent.core.persistence.vector_database import (
    VectorCollection,
    VectorDatabase,
    BaseDocument as VectorDocument,
)
from orionix_agent.core.persistence.vector_database_helper import (
...
class JourneyVectorStore(JourneyStore):
    ...
    async def _vector_document_loader(self, doc: VectorDocument) -> Optional[JourneyVectorDocument]:
        async def v0_1_0_to_v0_3_0(doc: VectorDocument) -> Optional[VectorDocument]:
            raise Exception(
                "This code should not be reached! Please run the 'orionix_agent-prepare-migration' script."
            )
