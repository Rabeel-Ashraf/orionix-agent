...
from orionix_agent.api.authorization import AuthorizationPolicy, Operation
from orionix_agent.api.common import GuidelineIdField, ExampleJson, JSONSerializableDTO, apigen_config
from orionix_agent.api.glossary import TermSynonymsField, TermIdPath, TermNameField, TermDescriptionField
from orionix_agent.core.agents import AgentId, AgentStore
from orionix_agent.core.application import Application
from orionix_agent.core.async_utils import Timeout
from orionix_agent.core.common import DefaultBaseModel
from orionix_agent.core.customers import CustomerId, CustomerStore
from orionix_agent.core.engines.types import UtteranceRationale, UtteranceRequest
from orionix_agent.core.loggers import Logger
from orionix_agent.core.nlp.generation_info import GenerationInfo
from orionix_agent.core.nlp.moderation import ModerationService
...
from orionix_agent.core.canned_responses import CannedResponseId
...
def _get_jailbreak_moderation_service(logger: Logger) -> ModerationService:
    from orionix_agent.adapters.nlp.lakera import LakeraGuard
