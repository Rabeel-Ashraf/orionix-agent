...
from orionix_agent.adapters.db.json_file import JSONFileDocumentCollection, JSONFileDocumentDatabase
...
from orionix_agent.core import async_utils
from orionix_agent.core.agents import (
    AgentDocumentStore,
    AgentId,
    AgentStore,
...
from orionix_agent.core.async_utils import Timeout, default_done_callback
from orionix_agent.core.capabilities import CapabilityId, CapabilityStore, CapabilityVectorStore
from orionix_agent.core.common import IdGenerator, ItemNotFoundError, JSONSerializable, Version
from orionix_agent.core.context_variables import (
    ContextVariable,
...
from orionix_agent.core.customers import (
    Customer as _Customer,
    CustomerDocumentStore,
    CustomerId,
    CustomerStore,
)
from orionix_agent.core.emissions import EmittedEvent, EventEmitterFactory
from orionix_agent.core.engines.alpha.prompt_builder import PromptBuilder, PromptSection
from orionix_agent.core.engines.alpha.hooks import EngineHook, EngineHookResult, EngineHooks
from orionix_agent.core.engines.alpha.loaded_context import LoadedContext, Interaction, InteractionMessage
from orionix_agent.core.glossary import GlossaryStore, GlossaryVectorStore, TermId
...
from orionix_agent.core.nlp.generation import (
    FallbackSchematicGenerator,
    SchematicGenerationResult,
    SchematicGenerator,
)
from orionix_agent.core.nlp.tokenization import EstimatingTokenizer
from orionix_agent.core.persistence.common import ObjectId
from orionix_agent.core.persistence.document_database import DocumentDatabase, identity_loader_for
...
from orionix_agent.core.services.indexing.behavioral_change_evaluation import BehavioralChangeEvaluator
from orionix_agent.core.services.tools.service_registry import ServiceDocumentRegistry, ServiceRegistry
...
from orionix_agent.core.canned_responses import (
...
from orionix_agent.core.journeys import (
    JourneyEdgeId,
    JourneyId,
    JourneyNodeId,
    JourneyStore,
...
from orionix_agent.core.loggers import LogLevel, Logger
from orionix_agent.core.nlp.service import NLPService
from orionix_agent.core.nlp.moderation import (
    ModerationCheck,
    ModerationService,
    ModerationTag,
    NoModeration,
...
from orionix_agent.bin.server import PARLANT_HOME_DIR, start_orionix_agent, StartupParameters
from orionix_agent.core.services.tools.plugins import PluginServer, ToolEntry, tool
from orionix_agent.core.tags import Tag as _Tag, TagDocumentStore, TagId, TagStore
from orionix_agent.core.tools import (
    ControlOptions,
    Lifespan,
    SessionMode,
    SessionStatus,
...
class NLPServices:
    ...
    def anthropic(container: Container) -> NLPService:
        ...
        from orionix_agent.adapters.nlp.anthropic_service import AnthropicService
    ...
    def cerebras(container: Container) -> NLPService:
        ...
        from orionix_agent.adapters.nlp.cerebras_service import CerebrasService
    ...
    def together(container: Container) -> NLPService:
        ...
        from orionix_agent.adapters.nlp.together_service import TogetherService
    ...
    def gemini(container: Container) -> NLPService:
        ...
        from orionix_agent.adapters.nlp.gemini_service import GeminiService
...
class Server:
    ...
    async def __aenter__(self) -> Server:
        self._startup_context_manager = start_orionix_agent(self._get_startup_params())
            ...
            async def make_mongo_db(url: str, name: str) -> DocumentDatabase:
                ...
                if importlib.util.find_spec("pymongo") is None:
                    raise SDKError(
                        ...
                        "Please install orionix_agent[mongo] to use MongoDB."
                    )

                from pymongo import AsyncMongoClient
                from orionix_agent.adapters.db.mongo_db import MongoDocumentDatabase
                ...
                db = await self._exit_stack.enter_async_context(
                    MongoDocumentDatabase(
                        ...
                        database_name=f"orionix_agent_{name}",
                        logger=c()[Logger],
                    )
                )
