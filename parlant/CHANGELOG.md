...
- Please see the announcement at https://orionix_agent.io/blog/orionix_agent-3-0-release
...
- Fixed orionix_agent client using old imports from python client SDK
...
- Change default home dir from runtime-data to orionix_agent-data
