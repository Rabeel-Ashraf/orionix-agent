...
from orionix_agent.api import agents, common
from orionix_agent.api.authorization import Operation, AuthorizationPolicy
from orionix_agent.api.common import (
...
from orionix_agent.api.index import LegacyInvoiceDTO
from orionix_agent.core.agents import AgentStore, AgentId
from orionix_agent.core.common import (
    DefaultBaseModel,
)
from orionix_agent.api.common import (
    ExampleJson,
...
from orionix_agent.core.tags import TagId, TagStore, Tag
from orionix_agent.core.tools import Tool, ToolId
...
def create_legacy_router(
    ...
    async def create_guidelines(
        ...
        See the [documentation](https://orionix_agent.io/docs/concepts/customization/guidelines) for more information.
