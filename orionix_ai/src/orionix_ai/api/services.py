...
from orionix_agent.core.services.tools.service_registry import ServiceRegistry, ToolServiceKind
from orionix_agent.core.tools import ToolService
...
ServiceOpenAPIParamsSourceField: TypeAlias = Annotated[
    ...
    Field(
        ...
        examples=["https://api.example.com/openapi.json", "/etc/orionix_agent/specs/example-api.yaml"],
    ),
]
